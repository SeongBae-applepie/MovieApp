...
function add_post() {
  window.location.href = "http://127.0.0.1:51713/insert_post?id=" + db_num;
}
...
fetch("http://127.0.0.1:51713/get_uuid_users_name")
  .then((res) => {
    return res.json();
  })
  .then((data) => {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      div_o.setAttribute("id", data[i].uuid_users);
      //41
      ...
      div_o.appendChild(div_1_41).appendChild(div_1_42);
